...
def parse_train_configs():
    parser = argparse.ArgumentParser(description='The Implementation of YOLO3D-YOLOv3 using PyTorch')
    ##############     Model configs            ########################
    ...
    """
    # Yolo3d - Yolov3 - tiny
    parser.add_argument('--model_def', type=str, default='config/cfg/yolo3d_yolov3_tiny.cfg', metavar='PATH', help='The path for cfgfile (only for darknet)')
    # parser.add_argument('--pretrained_path', type=str, default="checkpoints/yolov3-tiny.weights", metavar='PATH', help='the path of the pretrained checkpoint')
    parser.add_argument('--pretrained_path', type=str, default="checkpoints/Model_yolo3d_yolov3_tiny.pth", metavar='PATH', help='the path of the pretrained checkpoint')
    parser.add_argument('--save_path', type=str, default="checkpoints/Model_yolo3d_yolov3_tiny.pth", metavar='PATH', help='the path of the save checkpoint')
    """
